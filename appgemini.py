...
st.markdown('''
    ...
    .stTextInput input, div[data-baseweb="select"], .stTextArea textarea { background-color: #151b2b !important; color: #f1f5f9 !important; border: 1px solid #334155 !important; border-radius: 8px !important;
    transition: all 0.3s ease; }
    .setting-panel { background: #111624; border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 12px; padding: 24px; margin-bottom: 24px;
    ...
    font-size: 16px !important; border-radius: 8px !important; border: none !important; width: 100%; padding: 16px !important; transition: all 0.3s ease !important;
...
5. NO FORMAL GRAMMAR: STRICTLY PROHIBITED to use formal literary markers (၌,၍, သည့်, သည်, ၏).
Use natural spoken endings (တယ်, တဲ့, မှာ, ရဲ့).
...
RULES: Include camera angles, lighting conditions, and extreme details. Avoid explicit/violent words.
Do NOT include text or words in the prompt. MUST BE IN PURE ENGLISH.
                ...
                if groq_key_val:
                    try:
                        ...
                        if total_sw > 0 and total_ww >= 3:
                            ...
                            st.error("❌ Whisper ဆီမှ Word-level timestamps အလုံအလောက် မရရှိပါ။ (Audio ဖိုင်တိုလွန်းနေနိုင်ပါသည်)")
                            fc_parsed = None
